...
RSpec.describe 'User post index page', type: :system do
  before do
    ...
    Post.create(id: 1, user_id: 1, title: 'Test 1', text: 'Testing whith Capybera ', comments_counter: 0,
                likes_counter: 0)

    Post.create(id: 2, user_id: 1, title: 'Test 2', text: 'Testing whith Capybera ', comments_counter: 0,
                likes_counter: 0)

    Post.create(id: 3, user_id: 1, title: 'Test 3', text: 'Testing whith Capybera ', comments_counter: 0,
                likes_counter: 0)

    Post.create(id: 4, user_id: 1, title: 'Test 4', text: 'Testing whith Capybera', comments_counter: 0,
                likes_counter: 0)

    Comment.create(user_id: 1, post_id: 2, text: 'I like Capybera')
